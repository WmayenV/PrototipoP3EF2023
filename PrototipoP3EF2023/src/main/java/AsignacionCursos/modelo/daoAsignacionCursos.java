 ...
 */
package AsignacionCursos.modelo;

import AsignacionCursos.controlador.clsAsignacionCursos;
 ...
 * @author visitante
 */
public class daoAsignacionCursos {
    ...
    public List<clsAsignacionCursos> consultaConcepto() {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        
        List<clsAsignacionCursos> conceptos = new ArrayList<>();
        try {
		...
		String estatus = rs.getString("concEstatus");
               clsAsignacionCursos concepto = new clsAsignacionCursos();
    ...
    public int ingresaConcepto(clsAsignacionCursos concepto) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
        try {
    ...
    public int actualizaConcepto(clsAsignacionCursos concepto) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
        try {
    ...
    public int borrarConcepto(clsAsignacionCursos concepto) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
    ...
    public clsAsignacionCursos consultaConceptoPorNombre(clsAsignacionCursos concepto) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
    ...
    public clsAsignacionCursos consultaConceptoPorId(clsAsignacionCursos concepto) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
